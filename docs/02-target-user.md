...
Refactorika is deliberately narrow for v1, both to ship something demoable and to avoid overclaiming:
...
- **Python only.** No multi-language support in v1. (Refactorika itself is also written in Python.)
